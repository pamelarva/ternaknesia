...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2024 at 06:16 PM
...
--
-- Constraints for table `ahli_konsultasi`
--
ALTER TABLE `ahli_konsultasi`
  ADD CONSTRAINT `ahli_konsultasi_ibfk_1` FOREIGN KEY (`id_admin`) REFERENCES `admin` (`id_admin`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tips`
  ADD CONSTRAINT `tips_ibfk_1` FOREIGN KEY (`id_admin`) REFERENCES `admin` (`id_admin`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
