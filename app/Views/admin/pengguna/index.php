        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="<?= base_url('admin/pengguna') ?>" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Pengguna</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="display: flex; gap: 8px;">
                                            <a class="btn btn-sm btn-danger" href="javascript:void(0);" onclick="confirmDelete('<?= $user['nama'] ?>')">Hapus</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
