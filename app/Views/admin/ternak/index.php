...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="<?= base_url('admin/ternak') ?>" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Ternak</a>
        ...
        <div class="content">
                        ...
                        <tbody>
                            <?php if (!empty($ternak)): ?>
                                <?php foreach ($ternak as $item): ?>
                                    <tr>
                                        <th><?= $item['id_ternak'] ?></th>
                                        <td><?= $item['jenis_ternak'] ?></td>
                                        <td><?= $item['jumlah'] ?></td>
                                        <td><?= $item['usia'] ?></td>
                                        <td><?= $item['berat'] ?></td>
                                        <td>
                                        <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#confirmDelete<?= $item['id_ternak'] ?>">
                                            Hapus
                                        </button>
                                        </td>
                                    </tr>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6" class="text-center">Data ternak tidak ditemukan.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                        </table>
            ...
            <div class="modal fade" id="confirmDelete<?= $item['id_ternak'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?= base_url('admin/ternak/delete/' . $item['id_ternak']) ?>" class="btn btn-danger">Hapus</a>
                </div>
                </div>
            </div>
            </div>
