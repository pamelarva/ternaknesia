            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Ahli Konsultasi</h6>
                        <div>
                            <a class="btn btn-sm btn-primary" href="<?= base_url('admin/konsultasi/create'); ?>" style="margin-right: 15px;">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th><?= $ahli['id_ahlikonsultasi'] ?></th>
                                    <td><?= $ahli['nama_ahli'] ?></td>
                                    <td><?= $ahli['catatan'] ?></td>
                                    <td><?= $ahli['pendidikan'] ?></td>
                                    <td><?= $ahli['no_hp'] ?></td>
                                    <td><?= $ahli['link_github'] ?></td>
                                    <td><?= $ahli['link_instagram'] ?></td>
                                    <td><?= $ahli['lokasi'] ?></td>
                                    <td>
                                        <div style="display: flex; gap: 8px;">
                                            <a class="btn btn-sm btn-danger" href="javascript:void(0);" onclick="confirmDelete('<?= $ahli['nama_ahli'] ?>')">Hapus</a>
                                            <a class="btn btn-sm btn-warning" href="<?= base_url('/admin/konsultasi/edit/'.$ahli['id_ahlikonsultasi']); ?>">Edit</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
