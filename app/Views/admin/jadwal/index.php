...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="<?= base_url('admin/jadwal') ?>" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Jadwal</a>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-dark">
                                    ...
                                    <th scope="col">Waktu Pemberian 1</th>
                                    <th scope="col">Waktu Pemberian 2</th>
                                    <th scope="col">Waktu Pemberian 3</th>
                                    <th scope="col">Banyaknya Pakan</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th><?= $schedule['id_ternak'] ?></th>
                                    <td><?= $schedule['jenis_ternak'] ?></td>
                                    <td><?= $schedule['jenis_pakan'] ?></td>
                                    <td><?= $schedule['waktu_pemberian1'] ?></td>
                                    <td><?= $schedule['waktu_pemberian2'] ?></td>
                                    <td><?= $schedule['waktu_pemberian3'] ?></td>
                                    <td><?= $schedule['banyaknya_pakan'] ?></td>
                                    <td>
                                        <div style="display: flex; gap: 8px;">
                                            <!-- Tombol Hapus -->
                                            <a class="btn btn-sm btn-danger" href="javascript:void(0);" onclick="confirmDelete('<?= $schedule['id_ternak'] ?>')">Hapus</a>
                                        </div>
                                    </td>
    ...
    <script>
                                        function confirmDelete(id_ternak) {
                                            if (confirm('Apakah Anda yakin ingin menghapus jadwal pakan ini?')) {
                                                window.location.href = '<?= base_url('admin/jadwal/delete/') ?>' + id_ternak;
                                            }
                                        }
                                    </script>
