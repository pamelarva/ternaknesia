...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="<?= base_url('admin/konten') ?>" class="nav-item nav-link  active"><i class="fa fa-keyboard me-2"></i>Konten</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Tips</h6> <!-- Judul diubah menjadi Tips -->
                        <div>
                            <a class="btn btn-sm btn-primary" href="<?= base_url('admin/tips/create'); ?>" style="margin-right: 15px;">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-dark">
                                    <th scope="col">Id</th>
                                    <th scope="col">Waktu Upload</th> <!-- Mengubah Nama menjadi Judul -->
                                    <th scope="col">judul</th> <!-- Menambahkan Deskripsi -->
                                    <th scope="col">Link video</th> <!-- Menambahkan Tanggal -->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th><?= $tip['id_tips'] ?></th> <!-- Menyesuaikan dengan ID tips -->
                                    <td><?= $tip['waktu_upload'] ?></td> <!-- Menampilkan judul tips -->
                                    <td><?= $tip['judul'] ?></td> <!-- Menampilkan deskripsi tips -->
                                    <td><?= $tip['link_video'] ?></td> <!-- Menampilkan tanggal tips -->
                                    <td>
                                        <div style="display: flex; gap: 8px;">
                                            <a class="btn btn-sm btn-danger" href="javascript:void(0);" onclick="confirmDelete('<?= $tip['id_tips'] ?>')">Hapus</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
    ...
    <script>
        function confirmDelete(id_tips) {
    if (confirm(`Apakah Anda yakin ingin menghapus tips "${id_tips}"?`)) {
        // Jika user menekan OK, redirect ke URL delete
        window.location.href = '<?= base_url("admin/tips/delete/") ?>' + id_tips;
    }
}
