        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="<?= base_url('admin/produksi') ?>" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Produksi</a>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-dark">
                                    ...
                                    <th scope="col">Gambar Produksi</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if (!empty($item['gambar_produksi'])): ?>
                                            <img src="<?= base_url('uploads/' . $item['gambar_produksi']) ?>" alt="Gambar Produksi" width="100">
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <div style="display: flex; gap: 8px;">
                                            <!-- Tombol Hapus -->
                                            <a class="btn btn-sm btn-danger" href="javascript:void(0);" onclick="confirmDelete('<?= $item['id_produksi'] ?>')">Hapus</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
