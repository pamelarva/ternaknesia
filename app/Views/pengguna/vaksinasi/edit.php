...
<div class="container mt-5">
  <div class="row">
    <div class="col-md-8 offset-md-2">
      ...
      <form method="POST" action="<?= base_url('pengguna/vaksinasi/update/' . $vaksinasi['id_vaksinasi']); ?>">
        <?= csrf_field(); ?>

        <div class="form-group">
          <label for="nama_vaksin">Nama Vaksin</label>
          <input type="text" class="form-control" id="nama_vaksin" name="nama_vaksin" value="<?= old('nama_vaksin', $vaksinasi['nama_vaksin']); ?>" required>
        ...
        <div class="form-group">
            ...
            <input 
                ...
                value="<?= old('waktu_vaksinasi', date('Y-m-d\TH:i', strtotime($vaksinasi['waktu_vaksinasi']))); ?>" 
                required>
        ...
        <div class="form-group">
          ...
          <input type="number" step="0.01" class="form-control" id="dosis" name="dosis" value="<?= old('dosis', $vaksinasi['dosis']); ?>" required>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="nama_tenaga_medis" name="nama_tenaga_medis" value="<?= old('nama_tenaga_medis', $vaksinasi['nama_tenaga_medis']); ?>" required>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="id_ternak" name="id_ternak" required>
                ...
                <option value="<?= $item['id_ternak']; ?>" <?= old('id_ternak', $vaksinasi['id_ternak']) == $item['id_ternak'] ? 'selected' : ''; ?>>
        ...
        <button type="submit" class="btn btn-primary mt-3">Update Vaksinasi</button>
