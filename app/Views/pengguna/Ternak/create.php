...
<head>
  ...
  <title>Tambah Produksi Ternak</title>
</head>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-8 offset-md-2">
        <h2>Tambah Produksi Ternak</h2>
        <form method="POST" action="<?= base_url('pengguna/ternak/store') ?>" enctype="multipart/form-data">
          <div class="form-group">
            <label for="jenis_ternak">Jenis Ternak</label>
            <input type="text" class="form-control" id="jenis_ternak" name="jenis_ternak" placeholder="Masukkan jenis ternak" required>
          </div>
          <div class="form-group">
            <label for="jumlah">Jumlah Produksi</label>
            <input type="number" class="form-control" id="jumlah" name="jumlah" placeholder="Masukkan jumlah produksi" required>
          </div>
          <div class="form-group">
            <label for="usia">Usia Ternak</label>
            <input type="number" class="form-control" id="usia" name="usia" placeholder="Masukkan usia ternak" required>
          </div>
          <div class="form-group">
            <label for="berat">Berat Ternak</label>
            <input type="number" class="form-control" id="berat" name="berat" placeholder="Masukkan berat ternak" required>
          </div>
          <button type="submit" class="btn btn-primary mt-3">Tambah Produksi</button>
          <a href="<?= base_url('pengguna/ternak') ?>" class="btn btn-secondary mt-3">Kembali</a>
        </form>
      </div>
    </div>
  </div>
