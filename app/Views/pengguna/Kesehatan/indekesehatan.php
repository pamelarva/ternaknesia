		  ...
		  <div class="row mb-3">
			...
			<div class="col-12 text-right" style="position: relative;">
				<button style="border-radius: 50%; width: 40px; height: 40px; position: absolute; top: -20px; right: 0; display: flex; justify-content: center; align-items: center; background-color: #FF9F00; border: none;">
					<a href="pemeriksaan/create"><i class="fas fa-plus" style="color: white;"></i></a>				  
			  </button>
			</div>
		  </div>
		  <div class="row mb-5">
			<form class="col-md-12" method="post">
			  <div class="site-blocks-table">
				<table class="table">
				  ...
				  <tbody>
					<?php $no = 1; foreach($kesehatan as $kesehatanItem): ?>
					<tr>
					  <td><?= $no++; ?></td>
					  <td><?= $kesehatanItem['waktu_pemeriksaan']; ?></td>
					  <td><?= $kesehatanItem['nama_pemeriksa']; ?></td>
					  <td><?= $kesehatanItem['gejala']; ?></td>
					  <td><?= $kesehatanItem['kondisi_fisik']; ?></td>
					  <td><?= $kesehatanItem['diagnosa']; ?></td>
					  <td>
						<a href="<?= base_url('pengguna/pemeriksaan/edit/'.$kesehatanItem['id_pemeriksaan']); ?>" class="btn btn-primary btn-sm" title="Edit" style="background-color: #007bff; border: none;">
						  <i class="fas fa-edit" style="color: blue;"></i>
						</a>
						 <!-- Delete Button -->
                         <a href="<?= base_url('pengguna/pemeriksaan/delete/' . $kesehatanItem['id_pemeriksaan']) ?>" class="btn btn-danger btn-sm" title="Hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
