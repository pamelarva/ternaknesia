...
<div class="container mt-5">
  <div class="row">
    <div class="col-md-8 offset-md-2">
      ...
      <form method="POST" action="<?= base_url('pengguna/pemeriksaan/update/'.$kesehatan['id_pemeriksaan']); ?>">
        <div class="form-group">
          <label for="ternak">Pilih Ternak</label>
          <select class="form-control" id="ternak" name="ternak_id" required>
            <option value="">Pilih Ternak</option>
            <?php foreach ($ternaks as $ternakItem): ?>
              <option value="<?= $ternakItem['id_ternak']; ?>" <?= ($ternakItem['id_ternak'] == $kesehatan['id_ternak']) ? 'selected' : ''; ?>>
                <?= $ternakItem['jenis_ternak']; ?>
              </option>
            <?php endforeach; ?>
          </select>
        </div>
        ...
        <div class="form-group">
          ...
          <input type="datetime-local" class="form-control" id="waktuPemeriksaan" name="waktu_pemeriksaan" value="<?= $kesehatan['waktu_pemeriksaan']; ?>" required>
        </div>

        <div class="form-group">
          <label for="namaPemeriksa">Nama Pemeriksa</label>
          <input type="text" class="form-control" id="namaPemeriksa" name="nama_pemeriksa" value="<?= $kesehatan['nama_pemeriksa']; ?>" placeholder="Masukkan nama pemeriksa" required>
        </div>

        <div class="form-group">
          <label for="gejala">Gejala</label>
          <input type="text" class="form-control" id="gejala" name="gejala" value="<?= $kesehatan['gejala']; ?>" placeholder="Masukkan gejala" required>
        </div>

        <div class="form-group">
          <label for="kondisiFisik">Kondisi Fisik</label>
          <input type="text" class="form-control" id="kondisiFisik" name="kondisi_fisik" value="<?= $kesehatan['kondisi_fisik']; ?>" placeholder="Masukkan kondisi fisik" required>
        </div>

        <div class="form-group">
          <label for="diagnosa">Diagnosa</label>
          <input type="text" class="form-control" id="diagnosa" name="diagnosa" value="<?= $kesehatan['diagnosa']; ?>" placeholder="Masukkan diagnosa" required>
        </div>
